    ...
    return (
        <div className="p-3 bg-white text-black" style={styles.container}>
            ...
            <div className="text-center mb-3">
                ...
                {address && <div style={styles.businessInfo}>{address}</div>}
                {phone && <div style={styles.businessInfo}>Tel: {phone}</div>}
                {taxId && <div style={styles.businessInfo}>CUIT: {taxId}</div>}
            </div>
            ...
            {/* Ticket Info */}
            <div className="text-center mb-3">
                <div style={styles.ticketTitle}>TICKET DE VENTA</div>
                {invoice && <div style={styles.invoiceNumber}>Factura: {invoice}</div>}
