...
const generateReceiptInfo = (
  ...
  employeeName?: string
    ...
    <div class="thermal-row">
        <div class="thermal-row-left thermal-bold">Mesa/ID:</div>
        <div class="thermal-row-right thermal-critical">${escapeHtml(tableNumber)}</div>
    </div>` : ''}
    ${employeeName ? `
    <div class="thermal-row">
        <div class="thermal-row-left thermal-bold">Empleado:</div>
        <div class="thermal-row-right thermal-bold">${escapeHtml(employeeName)}</div>
    </div>` : ''}
    <div class="thermal-separator"></div>
