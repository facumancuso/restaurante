  ...
  return `
    ...
    <body>
        <div class="center">
            ...
            ${address ? `<div class="business-info">${address}</div>` : ''}
            ${phone ? `<div class="business-info">Tel: ${phone}</div>` : ''}
            ${taxId ? `<div class="business-info">CUIT: ${taxId}</div>` : ''}
        </div>
        
        <div class="separator"></div>
        
        <div class="center">
            <div class="ticket-title">${type === 'kitchen' ? 'COMANDA DE COCINA' : 'TICKET DE VENTA'}</div>
            ${invoice ? `<div class="invoice-number">Factura: ${invoice}</div>` : '<div class="invoice-number">VISTA PREVIA</div>'}
